...
【非软件开发任务 - 需要强推理模型】
- 专业咨询:法律、医疗、财务等专业领域的严谨分析与建议
- 复杂分析:数据分析、商业分析、方案对比、多因素权衡、研究报告
- 创意构思:创意策划、营销方案构思、故事构思、设计方向探索
- 长文理解:阅读长文档、论文解读、合同审查、报告提炼
- 逻辑推理:数学证明、逻辑题、复杂推理问题、学术研究

【非软件开发任务 - 普通或快速模型即可】
- 内容生成:按明确要求写文案、翻译、改写、扩写、格式转换
- 简单咨询:常识查询、信息检索、简单问答、生活建议
- 文档撰写:按模板或要求写报告、邮件、文档、总结
- 学习辅导:知识点讲解、习题解答、学习建议
